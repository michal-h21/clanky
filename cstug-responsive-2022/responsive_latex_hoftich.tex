...
telefonů může být naopak menší. 

Stejný problém řeší webové prohlížeče,
...
\begin{figure}[tbp]
  \caption{Rozdíl velikosti písma v závislosti na počtu znaků}\label{fig:fontsize}
  \begin{subfigure}[t]{0.45\textwidth}
\fbox{%
\begin{minipage}{5cm}
\ResponsiveSetup{characters=55}
...
callbacků v jazyce Lua, můžeme například omezit výskyt takových typografických
...
\balicek{Linebreaker} nahrazuje výchozí 
funkci pro řádkový zlom upravenou verzí, která detekuje přetečení nebo podtečení lámaného 
