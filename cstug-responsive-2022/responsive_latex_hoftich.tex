...
\begin{description}
  \item[noautomatic] – zabrání nastavení velikost písma a řádkování automaticky na začátku dokumentu.
...
Pomocí nich můžeme testovat, že daný rozměr je menší nebo větší
než zadaná hodnota.
