...
Díky využití Lua\TeX u  můžeme 


% \begin{figure}
%   \includegraphics[width=.95\textwidth]{img/lua-widow.pdf}
%   \caption{Porovnání různých metod k omezení parchantů}
%   \label{fig:widow}
% \end{figure}



  \subsection{Balíček \texttt{lua-widow-control}}
