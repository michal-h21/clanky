...
V tomto textu představím některé tipy k sazbě různých verzí dokumentů určených
pro různé cílové výstupy, jak tištěné, tak elektronické, například pro čtečky
e-booků nebo tablety.   
