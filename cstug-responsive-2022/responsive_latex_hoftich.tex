...
Inspiroval jsem se článekem Edoarda Cavazza \cite{cavazza} o čitelnosti
...
Efekt změny hodnoty můžete pozorovat v obrázku~\ref{fig:lineratio}. 
Správná hodnota je individuální, doporučuji s ní experimentovat.
