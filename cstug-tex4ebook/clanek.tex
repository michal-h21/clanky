...
ovšem bylo by lepší, kdyby k tomuto nedocházelo. Jedná se o chybu při konverzi
\texttt{DVI} souboru příkazem \texttt{tex4ht}, který se snaží přidat
formátování podle písma detekovaného v \texttt{DVI} souboru, ovšem pokud narazí
na znak s diakritikou, uzavře současný element. Tento problém lze vyřešit
jednoduchou konfigurací v konfiguračním souboru:
