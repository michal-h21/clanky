...
pozici. Pro Epub je třeba používat volbu druhou z nich. Dále je v konfiguračním
souboru možno přidávat konfigurace pro háčky, v našem příkladu užíváme dvě
konfigurace, pro příkazy \verb|textbf| a \verb|textit|. Příkaz
\verb|\Configure| má variabilní počet argumentů, pro jednotlivé konfigurace je
třeba konzultovat dokumentaci\footnote{Dokumentace není úplně silnou stránkou
  projektu TeX4ht. Základní informace o konfiguraci se nachází na WWW stránkách
  projektu, detailnější informace můžete získat z dokumentace vygenerované ze
  zdrojových kódů TeX4ht, umístěných na stránkách
