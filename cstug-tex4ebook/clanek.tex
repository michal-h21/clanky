...
\newcommand\mybibitem[2][]{\phantomsection\edef\@currentlabel{#1, \year}\label{#2}}
...
\def\year{2016}
 ...
 \publS{\mybibitem{bib:latex2html} \nazev{LaTeX2HTML}. \www{http://www.latex2html.org/} \citovano}

  \mybibitem{bib:latexml}  Bruce Miller. \nazev{LaTeXML}. \www{http://dlmf.nist.gov/LaTeXML/} \citovano.
  \mybibitem{bib:pandoc} \nazev{Pandoc}. \www{http://pandoc.org/} \citovano.
  \mybibitem{bib:tex4ht} Eitan Gurari. \nazev{TeX4ht}. \www{http://www.tug.org/tex4ht/} \citovano.
  \mybibitem{bib:tex4ebook} Michal Hoftich. \nazev{TeX4ebook}. \www{https://www.ctan.org/pkg/tex4ebook} \citovano.
  \mybibitem{bib:make4ht} Michal Hoftich. \nazev{Make4ht}. \www{https://www.ctan.org/pkg/make4ht} \citovano.
  \mybibitem{bib:viljamis} Viljami Salminen. \nazev{Scale.css}. \www{https://github.com/viljamis/Scale} \citovano.
  \mybibitem{bib:edupub} The EPUB Working Group. \nazev{EPUB for Education}. \www{http://www.idpf.org/epub/profiles/edu/spec/} \citovano.
  \mybibitem{bib:ipdf}  The International Digital Publishing Forum. \nazev{EPUB 3}. \www{http://idpf.org/epub/30} \citovano.
  \mybibitem{bib:mathjax} The MathJax Consortium. \nazev{EPUB3 Reading systems overview}. \www{http://docs.mathjax.org/en/latest/misc/epub.html} \citovano.
\ebib
