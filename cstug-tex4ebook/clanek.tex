...
\def\year{2016}
 ...
 \publP{\mybibitem[IDPF]{bib:ipdf}  \autor{The International Digital Publishing Forum} \nazev{EPUB 3} \www{http://idpf.org/epub/30} \citovano}

 \publP{ \mybibitem[The Mathjax Consortium]{bib:mathjax} \autor{The MathJax Consortium} \nazev{EPUB3 Reading systems overview} \www{http://docs.mathjax.org/en/latest/misc/epub.html} \citovano}
