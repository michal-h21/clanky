...
\newcommand\citovano[1][14.\,10.\,2016]{[cit. #1]}
...
z~dokumentace vygenerované ze zdrojových kódů TeX4ht, umístěných na stránkách
...
zařízení podporovat, realita je ovšem odlišná\footnote{Tabulku shrnující
  podporu lze nalézt na stránkách knihovny MathJax~\cite{bib:mathjax}}. Pokud MathML
...
\begin{thebibliography}{plain}
  \bibitem{bib:aeneas} Alberto Pettarin. \textit{Aeneas}. \url{https://www.readbeyond.it/aeneas/} \citovano.
  \bibitem{bib:menestrello} Alberto Pettarin. \textit{Menestrello}.  \url{https://www.readbeyond.it/menestrello/index.html} \citovano.
  \bibitem{bib:latex2html} \textit{LaTeX2HTML}. \url{http://www.latex2html.org/} \citovano.
  \bibitem{bib:latexml}  Bruce Miller. \textit{LaTeXML}. \url{http://dlmf.nist.gov/LaTeXML/} \citovano.
  \bibitem{bib:pandoc} \textit{Pandoc}. \url{http://pandoc.org/} \citovano.
  \bibitem{bib:tex4ht} Eitan Gurari. \textit{TeX4ht}. \url{http://www.tug.org/tex4ht/} \citovano.
  \bibitem{bib:tex4ebook} Michal Hoftich. \textit{TeX4ebook}. \url{https://www.ctan.org/pkg/tex4ebook} \citovano.
  \bibitem{bib:make4ht} Michal Hoftich. \textit{Make4ht}. \url{https://www.ctan.org/pkg/make4ht} \citovano.
  \bibitem{bib:viljamis} Viljami Salminen. \textit{Scale.css}. \url{https://github.com/viljamis/Scale} \citovano.
  \bibitem{bib:edupub} The EPUB Working Group. \textit{EPUB for Education}. \url{http://www.idpf.org/epub/profiles/edu/spec/} \citovano.
  \bibitem{bib:ipdf}  The International Digital Publishing Forum. \textit{EPUB 3}. \url{http://idpf.org/epub/30} \citovano.
  \bibitem{bib:mathjax} The MathJax Consortium. \textit{EPUB3 Reading systems overview}. \url{http://docs.mathjax.org/en/latest/misc/epub.html} \citovano.
