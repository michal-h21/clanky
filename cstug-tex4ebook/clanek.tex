...
\begin{thebibliography}{plain}
  \bibitem{bib:aeneas} Alberto Pettarin. \textit{Aeneas}. \url{https://www.readbeyond.it/aeneas/}.
  \bibitem{bib:menestrello} Alberto Pettarin. \textit{Menestrello}.  \url{https://www.readbeyond.it/menestrello/index.html}.
  \bibitem{bib:latex2html} \textit{LaTeX2HTML}. \url{http://www.latex2html.org/}.
  \bibitem{bib:latexml}  Bruce Miller. \textit{LaTeXML}. \url{http://dlmf.nist.gov/LaTeXML/}.
  \bibitem{bib:pandoc} \textit{Pandoc}. \url{http://pandoc.org/}.
  \bibitem{bib:tex4ht} Eitan Gurari. \textit{TeX4ht}. \url{http://www.tug.org/tex4ht/}.
  \bibitem{bib:tex4ebook} Michal Hoftich. \textit{TeX4ebook}. \url{https://www.ctan.org/pkg/tex4ebook}.
  \bibitem{bib:make4ht} Michal Hoftich. \textit{Make4ht}. \url{https://www.ctan.org/pkg/make4ht}.
  \bibitem{bib:viljamis} Viljami Salminen. \textit{Scale.css}. \url{https://github.com/viljamis/Scale}.
  \bibitem{bib:edupub} The EPUB Working Group. \textit{EPUB for Education}. \url{http://www.idpf.org/epub/profiles/edu/spec/}
  \bibitem{bib:ipdf}  The International Digital Publishing Forum. \textit{EPUB 3}. \url{http://idpf.org/epub/30}.
  \bibitem{bib:mathjax} The MathJax Consortium. \textit{EPUB3 Reading systems overview}. \url{http://docs.mathjax.org/en/latest/misc/epub.html}.
