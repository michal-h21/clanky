...
Kvůli známé chybě při zpracování DVI souboru příkazem \prikaz{tex4ht} bude vytvořen HTML soubor, kde každý znak s~diakritikou bude umístěn v~samostatném elementu:
...
Rozdíl mezi nimi je ten, že první zpracovává svůj obsah jako vertikální box. V
každém případě je se obsah mezi těmito příkazy a ukončovacím příkazem
...
dotkli pouze základů. Vynechali jsme také ukázky, jakým způsobem lze přidat
konfiguraci pro nový \LaTeX ový balíček. Tato témata by vydala na rozsáhlé
samostatné články. V současné době probíhá za finanční podpory poskytnuté
\nazev{Českoskovenským sdružením uživatelů \TeX u} tvorba nové dokumentace pro
\nazev{TeX4ht}, kde budou tato témata probrána do hloubky.
