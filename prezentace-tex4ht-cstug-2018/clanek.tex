...
nepodporuje veškeré balíčky a uživatelské příkazy. 
...
konfigurace se může schodovat s názvem konfigurovaného příkazu, jako v tomto
...
konfigurované prostředí založeno na seznamu. HTML kód vytvořený touto konfigurací může vypadat následovně:
